AmCharts.AmPieChart = AmCharts.Class({
                ...
                for (l = 0; l < e.length; l++)
                    if (a = e[l], !0 !== a.hidden && 0 < a.percents) {
                        ...
                        if (this.labelsEnabled && this.labelText && a.percents >= this.hideLabelsPercent) {
                            ...
                            t = a.labelColor;
                            t || (t = this.color);
                            "" != h && (h = AmCharts.wrappedText(c, h, t, this.fontFamily, this.fontSize, B, !1, this.maxLabelWidth), AmCharts.setCN(this, h, "pie-label"), AmCharts.setCN(this, h, a.className, !0), h.translate(p + 1.5 * v, A), h.node.style.pointerEvents = "none", a.tx = p + 1.5 * v, a.ty = A, 0 <= r ? (r = h.getBBox(), t = AmCharts.rect(c, r.width + 5, r.height + 5, "#FFFFFF", .005), t.translate(p + 1.5 * v + r.x, A + r.y), a.hitRect = t, n.push(h), n.push(t)) : this.freeLabelsSet.push(h), a.label = h);
                            a.tx = p;
                            a.tx2 = p + v;
                            a.tx0 = x + q * g;
                            a.ty0 = y + z * g
    ...
    checkOverlapping: function (e, f, c, b, k) {
        ...
        if (m) {
            if (!0 === b)
                for (l = e + 1; l < u; l++) a[l].labelQuarter == c && (d = this.checkOverlappingReal(f, a[l], c)) && (l = u);
            else
    ...
    checkOverlappingReal: function (e, f, c) {
        var b = !1,
            k = e.label,
            d = f.label;
        e.labelQuarter != c || e.hidden || f.hidden || !d || (k = k.getBBox(), c = {}, c.width = k.width, c.height = k.height, c.y = e.ty, c.x = e.tx, e = d.getBBox(), d = {}, d.width = e.width, d.height = e.height, d.y = f.ty, d.x = f.tx, AmCharts.hitTest(c, d) && (b = !0));
        return b
    }
});